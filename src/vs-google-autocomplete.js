/**
 * vsGoogleAutocomplete - v0.4.3 - 2015-10-22
        ...
        return {
            ...
            controller: ['$scope', '$attrs', function($scope, $attrs) {
                ...
                this.updatePlaceComponents = function(place) {
                    ...
                    $scope.vsProvince     = !!$attrs.vsProvince && place     ? vsGooglePlaceUtility.getProvince(place)     : undefined;
                };
            }],
